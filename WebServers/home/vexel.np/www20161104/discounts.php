...
?>
	...
	<div class="stuffs">
		<div class="stuff" id="1" onclick="rediectToStuff(this.id);">
			...
			<img class="photo" alt="Фотография" src="/images/stuff/stuff0.png">
			<div class="aroundActions">
				...
				<button class="add button" onmouseenter="button = true;"
					onmouseleave="button = false;">в корзину</button><br>
		...
		<div class="stuff" id="1" onclick="rediectToStuff(this.id);">
			...
			<img class="photo" alt="Фотография" src="/images/stuff/stuff1.png">
			<div class="aroundActions">
		...
		<div class="stuff" id="1" onclick="rediectToStuff(this.id);">
			...
			<img class="photo" alt="Фотография" src="/images/stuff/stuff2.png">
			<div class="aroundActions">
				<span class="oldprice price">100 000</span><br> <span
					class="newprice price">60 000</span>
				<button class="add button" onmouseenter="button = true;"
