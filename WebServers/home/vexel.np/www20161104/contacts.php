...
<h1 class="h">Cвязаться с нами</h1>
	<div class="contactTypes">
		...
		<div class="type">
			<h3>Телефон</h3>
			<h4>Заказать звонок или позвонить</h4>
			<div class="postbuttons">
		...
		<div class="type">
			...
			<div class="postbuttons">
				<img class="postbutton button" alt="Telegram"
					...
					alt="WhatsApp" src="/images/contacts/messengers/wapp.png"><img class="postbutton button"
					alt="Skype" src="/images/contacts/others/skype.png">
			</div>
		</div>
	</div>
	<div class="advice">
