...
window.onload = function () {
    ...
    let switchDivImg = switchDiv.getElementsByTagName("img")[0];
    let switchDivSpan = switchDiv.getElementsByTagName("span")[0];
    switchDivSpan.style.width = switchDivImg.width;
    switchDivSpan.style.width = switchDivImg.width;
    switchDivSpan.style.display = 'block';
    switchDivSpan.style.top = -switchDivSpan.clientHeight + "px";
...
function generateTeam() {
    ...
    readTextFile("/json/team.json", function (text) {
        ...
        for (let i = 0; i < teamJSON.positions.length; i++) {
            ...
            teamGroupHeader.innerText = teamJSON.positions[i];
        ...
        for (let i = 0; i < teamJSON.team.length; i++) {
            ...
            teamGroup.appendChild(teamElement);
        }
    });
}
